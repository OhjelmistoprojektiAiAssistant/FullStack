          ...
          >
            <defs>
              ...
              >
                ...
                />
                <circle cx="20" cy="50" r="2" fill="currentColor" className="text-cyan-400" />
                <circle cx="50" cy="20" r="2" fill="currentColor" className="text-blue-400" />
                <circle cx="80" cy="80" r="2" fill="currentColor" className="text-indigo-400" />
              </pattern>
            </defs>
